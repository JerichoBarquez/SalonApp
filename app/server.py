...
from .colorsalon import ColorSalonClient 
...
async def websocket_handler(websocket: WebSocket, call_id: str):
    try:
        ...
        colorsalor_client = ColorSalonClient()
        ...
        response_id = 0
        first_event = colorsalor_client.draft_begin_message()
        ...
        async def handle_message(request_json):
            ...
            if (
                ...
                async for event in colorsalor_client.draft_response(request):
